    ...
    <>
      <Fade damping={0.5} triggerOnce={true} direction="up">
        <div
          ...
          id="hero"
        >
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-fit drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] bg-black bg-opacity-50 rounded">
